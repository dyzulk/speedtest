...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-between p-4 sm:p-6 lg:p-10 relative selection:bg-primary selection:text-primary-foreground">
